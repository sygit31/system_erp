	...
	function index()
	{
		...
		foreach ($dataX as $key => $value) {
			...
			foreach ($DetailTest as $Xkey => $Xvalue) {
				...
				if ($Xvalue->ID_TEST_CODE == '89' || $Xvalue->ID_TEST_CODE == '98') {$data['gsm'] = $Xvalue->HASIL_TEST;}
				if ($Xvalue->ID_TEST_CODE == '90') {$data['ketebalan'] = $Xvalue->HASIL_TEST;}
				if ($Xvalue->ID_TEST_CODE == '91') {$data['tape'] = $Xvalue->HASIL;}
				if ($Xvalue->ID_TEST_CODE == '92' || $Xvalue->ID_TEST_CODE == '99') {$data['gulungan'] = $Xvalue->HASIL;}
			}
