...
class Master_parameter extends CI_Controller{
	...
	{    
		...
		$this->load->view('qc/v_master_parameter.php',$data);
	}
	...
	public function editKategori($test_code)
	{
		...
		$data['kategori'] = $code;
		$this->load->view('qc/v_edit_master_parameter.php',$data);
	}
	...
	{   
		...
		if($success){
			...
			print_r("<meta http-equiv='refresh' content='0; url=".base_url()."index.php/qc/master_parameter'>");
