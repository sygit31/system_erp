...
class Cek_qc extends CI_Controller{
	...
	public function __construct()
	{
		...
		$this->load->model('M_test_qc_detail');
	...
	function index()
	{
		...
		$this->load->view('qc/v_cek_qc.php',$data);
	}
	...
	public function save()
	{
		...
		foreach ($dataDetail as $key) {
			...
			if ($status === "CLOSE" && $data['grade'] <= 2) { //Close Grade 1 & 2
				...
				$dataUpdate['KODE_ROLL'] = $FnomerLabel."-00-".$Fgrade."-".$Tahun;
			...
			print_r("<meta http-equiv='refresh' content='0; url=".base_url()."index.php/qc/cek_qc'>");
