...
class Mutasi_pet extends CI_Controller{
	...
	function getProsesAkhir()
	{
		...
		$get_kk = $this->M_mutasi_pet->get_kk_mutasi($nama_proses_awal);
    ...
    //rubah semua aktif 2 jadi 3 
		...
		for ($i=0; $i<count($data); $i++) {
		   ...
		   $this->M_mutasi_pet->update_edit_mutasi_detail ($no_mutasi,$id_pengirim,$id_penerima,$id_prod_mutasi,$tgl_mutasi);	
		}
