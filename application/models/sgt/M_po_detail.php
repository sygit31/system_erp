...
class M_po_detail extends CI_Model 
{
	...
	public function getPOoutstanding() 
	{
		...
		WHERE PD.STATUS = 'OTW' AND (B.ID = '1093' 
			OR B.ID = '3907' OR B.ID = '5925' 
			OR B.ID = '7327' OR B.ID = '7382' 
			OR B.ID = '7565' OR B.ID = '8461' 
			OR B.ID = '9388' OR B.ID = '9471'
			OR B.ID = '9475' OR B.ID = '9772'
			OR B.ID = '10527' OR B.ID = '11632'
			OR B.ID = '11918' OR B.ID = '12314'
			OR B.ID = '12315' OR B.ID = '12319' OR B.ID = '12322') ";
