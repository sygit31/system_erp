    ...
    <section class="content">
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
                ...
                <tbody>
                  ...
                  <?php foreach($order as $row){ ?>
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-block btn-warning btn-sm" id="<?php echo $row['OUTSTANDING'].'@'.$row['ID_GUDANG_ORDER']; ?>" data-toggle="modal" data-target="#modal-manual">Penuhi</button></td>
                    </tr>
                  <?php } ?> 
          ...
          <div class="modal fade bd-example-modal-lg" id="modal-detail">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  <form role="form" method="POST" action="<?php echo site_url('gudang/pengeluaran_barang/penuhi');?>" onsubmit="return validasi(this)">
                    ...
                    <div class="modal-header" style="background-color: #E6E6E6;">
                      ...
                      <table>
                        <tr valign="center">
                          ...
                          <td width="20"></td>
                          <td width="300"><input class="form-control" type="text" id="txtNomerIPB" name="txtNomerIPB"></td>
                        </tr>
                      </table>
                      ...
                      <div class="box box-info">
                        <div class="box-body">
                          <!-- ISI -->
                            <!-- <table>
                              <tr valign="top">
                                ...
                                <td width="350" colspan="2">
                                  <select class="form-control select2" style="width: 100%;" id="cmbBarang">
                                  </select>
                                </td>
                              </tr>
                              <tr valign="top">
                            ...
                            <label id="lblJumlah" name="lblJumlah">Total Barang : 0</label>
                          <!-- ISI -->
                        </div>
                      </div><!-- /.box-body -->
          ...
          <div class="modal fade bd-example-modal-lg" id="modal-manual">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  <form role="form" method="POST" action="<?php echo site_url('gudang/pengeluaran_barang/penuhiManual');?>" onsubmit="return validasiManual(this)">
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <form  method="POST" action="<?php echo site_url('gudang/pengeluaran_barang/tampil');?>">
            <div class="card card-info">
              <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <input type="button" value="View All" class="btn btn-warning pull-right" onclick="window.location.href='<?php echo site_url('gudang/pengeluaran_barang');?>'" />
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
                ...
                <tbody>
                  ...
                  <?php foreach($laporan_pengeluaran as $row){ ?>
                    <tr>
                      ...
                      <td align="center"><?php echo $row->NO_IPB; ?></td>
