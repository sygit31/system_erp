                  ...
                  <tbody>
                    ...
                    <?php foreach($order as $row){ ?>
                      <tr>
                        ...
                        <td align="center"><?php echo $row['LINK_PENGGUNAAN']; ?></td>
                        ...
                        <td><button type="button" class="btn btn-block btn-warning btn-sm" id="<?php echo $row['ID_BARANG'].'@'.$row['OUTSTANDING'].'@'.$row['ID_GUDANG_ORDER'].'@'.$row['OUTSTANDING'].'@'.$row['SERI']; ?>" data-toggle="modal" data-target="#modal-detail">Penuhi</button></td>
                      </tr>
                    <?php } ?> 
