          ...
          <div class="modal fade bd-example-modal-lg" id="modal-detail">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  <form role="form" method="POST" action="<?php echo site_url('gudang/penerimaan_barang/terima');?>" onsubmit="return validasi(this)" autocomplete="off">
                    ...
                    <div class="modal-header" style="background-color: #E6E6E6;">
                      ...
                      <table>
                        <tr valign="center">
                          ...
                          <td width="20"></td>
                          <td width="300">
                            <input type="text" id="dmTanggal" name="dmTanggal" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask readonly="true">
                          </td>
                        </tr>
                        <tr valign="center">
