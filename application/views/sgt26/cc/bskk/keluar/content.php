    ...
    <section class="content">
      ...
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">
            <b><font color="White">Keluar BSKK</font></b>
          </h3>
        ...
        <div class="card-body">
          ...
          <!-- ==================================ISI KONTEN================================== -->
            ...
            <form role="form" method="POST" action="<?php echo site_url('sgt/cc/bskk/simpanKeluar');?>" onsubmit="return validasi()" autocomplete="off">
            <table>
                <tr>
                    <td width="150">
                    ...
                    <td width="300" colspan="3">
                        <div data-tip="Periode pengeluaran">
                            <input class="form-control" type="text" id="txtPeriode" name="txtPeriode">
                        </div>
                    </td>
                </tr>
                <tr height="10" />
                <tr>
                    <td>
                        <label><font size = "4">Keterangan</font></label></td>
                    </td>
                    <td colspan="3">
                        <div data-tip="Keterangan pengeluaran">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <div data-tip="Jumlah Pengeluaran">
  ...
  <!-- <div class="content-wrapper"> -->
    ...
    <section class="content">
      ...
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">
            <b><font color="White">Data Keluar BSKK</font></b>
          </h3>
