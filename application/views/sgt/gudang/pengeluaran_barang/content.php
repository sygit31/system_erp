                          ...
                          <tr>
                            ...
                            <td width="300">
                              <select name="cmbPenerima"  id="cmbPenerima"  class="form-control select2" style="width: 100%;">
                                <option value=''></option>
                                <option value='Mustari'>Mustari</option> <!-- Jumadi 23-Dec-24 -->
                                <option value='Sarwoedi'>Sarwoedi</option> <!-- Jumadi 03-Dec-21 -->
                          ...
                          <tr>
                            ...
                            <td width="300">
                              <select name="cmbPemberi"  id="cmbPemberi"  class="form-control select2" style="width: 100%;">
                                ...
                                <option value='Andre AW.'>Andre AW.</option>
