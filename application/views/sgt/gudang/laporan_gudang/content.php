    ...
    <section class="content">
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <form  method="POST" action="<?php echo site_url('sgt/gudang/laporan_gudang/filter');?>">
            <div class="card card-info">
              <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <input type="button" value="View All" class="btn btn-warning pull-right" onclick="window.location.href='<?php echo site_url('sgt/gudang/laporan_gudang');?>'" />
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
