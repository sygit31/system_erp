    ...
    <section class="content">
      ...
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">
            <b><font color="White">Cetak Monitoring</font></b>
          </h3>
        ...
        <div class="card-body">
          ...
          <!-- ==================================ISI KONTEN================================== -->
          <form id="frmData" role="form" method="POST" action="<?php echo site_url('sgt/mk/cetak_monitoring/cetak');?>"  target="_blank">
          <table>
            <tr>
              <td width="150">
                ...
                <tbody>
                  ...
                  <?php foreach($dataTugas as $row){ ?>
                    <tr>
                      ...
                      <td align="center"><?php echo $row->NILAI_APPROV; ?></td>
                    </tr>
                  <?php } ?>
