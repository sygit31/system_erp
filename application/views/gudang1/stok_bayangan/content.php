    ...
    <section class="content">
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <!-- <form id="frm_input" method="POST" action="<?php //echo site_url('gudang/stok_bayangan/reject');?>" target="_blank"> -->
          <form id="frm_input" method="POST" action="<?php echo site_url('gudang/stok_bayangan/reject');?>" onsubmit="return validasi()">
                  ...
                  <tbody>
                    ...
                    <?php foreach($stok as $row){ ?>
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-block btn-warning btn-sm" id="<?php echo $row->ID_DETAIL_TERIMA."@".$row->BARCODE."@".$row->NAMA."@".$row->NOMER."@".$row->ID_BARANG; ?>" data-toggle="modal" data-target="#modal-detail">Detail</button></td>
                      </tr>
                    <?php } ?>
                ...
                <tbody>
                  ...
                  <?php foreach($reject as $row){ ?>
                    <tr>
                      ...
                      <td><a href="<?php echo site_url('gudang/stok_bayangan/print_reject?id='.$row->ID);?>" class="btn btn-block btn-danger btn-sm" target="_blank">Print</a></td>
                    </tr>
                  <?php } ?>
