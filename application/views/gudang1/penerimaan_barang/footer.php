...
<script type="text/javascript">
	...
	$('#modal-detail').on('show.bs.modal', function(e) {
    	...
    	setTimeout(function(){$("#txtKodeBarcode").focus();}, 300);
	})
	...
	function tambahTerima()
	{
	    ...
	    if (ValKodeBarcode == "" || ValKodeBarcode.length != 16) {
	    	alert("[KODE BARCODE] harus diisi 16 Digit!");
    		KodeBarcode.focus();
	    }else{
