          ...
          <div class="modal fade bd-example-modal-lg" id="modal-detail">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  <!-- <form role="form" method="POST" action="<?php //echo site_url('sgt/qc/cek_qc/save');?>" onsubmit="return simpan(this)"> -->
                  <form id="frm_input" method="POST" action="<?php echo site_url('sgt/qc/cek_qc/save');?>">
