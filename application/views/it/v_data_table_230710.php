<table id="data-table" class="table table-bordered table-striped" width="100%">
	<thead>
		<tr align="center" style="font-weight: bold;">
			...
			<td>View</td>
			<td>Unduh</td>
			<td <?php if($_SESSION['akses'] == '1') {echo 'hidden';} ?>>Hapus</td>
			<td <?php if($_SESSION['akses'] == '1') {echo 'hidden';} ?> hidden></td>
			<td hidden></td>
			<td hidden></td>
			<td>Edit</td>
		</tr>
	...
	<tbody>
		...
		foreach ($data->result_array() as $dt):
			...
			<tr>
				...
				<td align="center" <?php if($_SESSION['akses'] == '1') {echo 'hidden';} ?>><button type="button" class="btn btn-danger" onclick="hapus(this)" <?php if($_SESSION['akses'] == '1' && $aktif == '2') {echo 'hidden';} ?> title="Hapus"><i class="fa fa-close"></i></button></td>
