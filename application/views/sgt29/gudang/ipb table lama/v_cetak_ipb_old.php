...
<body>
    ...
    <table style="font-weight:bold;">
        <tr>
            <td width="700" align="center">IJIN PENGELUARAN BARANG (PETM)</td>
        </tr>
        <tr>
            <td align="center"><? echo $data_cetak[0]->NOMER; ?></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            ...
            <td width="10"> : </td>
            <td><? echo $data_cetak[0]->TANGGAL; ?></td>
        </tr>
        <tr>
            <td>Seri</td>
            <td> : </td>
            <td><? echo $data_cetak[0]->SERI; ?></td>
        </tr>
        <tr>
            <td>KK</td>
            <td> : </td>
            <td><? echo $data_cetak[0]->NO_KK; ?></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td width="0" />
            <td width="200" align="center">Yang Meminta</td>
            <td width="50" />
            <td width="200" align="center">Yang Memberi</td>
            <td width="50" />
        ...
        <tr>
            <td />
            <td align="center"><b>( <? echo $data_cetak[0]->PENERIMA; ?> )</b></td>
            <td />
            <td align="center"><b>( <? echo $data_cetak[0]->PEMBERI; ?> )</b></td>
            <td />
            <td align="center"><b>( <? echo $data_cetak[0]->PENGAWAS; ?> )</b></td>
            <td />
        </tr>
    </table>
