    ...
    <section class="content">
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <form  method="POST" action="<?php echo site_url('sgt/qc/laporan_qc/filter');?>">
            <div class="card card-info">
              <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <input type="button" value="View All" class="btn btn-warning pull-right" onclick="window.location.href='<?php echo site_url('sgt/qc/laporan_qc');?>'" />
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
