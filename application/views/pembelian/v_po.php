...
<div id="printable" style="display: none; color: #000; font-size: 18.7px; font-family: sans-serif; margin-left: 3mm; margin-right: 5mm;">
	...
	<div id="e_tgl" style="margin-right: 38mm; text-align: right; text-transform: uppercase;">18-Mei-2020</div>

	<div style="height: 6mm;"></div>
	<div id="e_nomor_spp" style="margin-left: 45mm;">20000005724 (001OFF/PNP-HLG/R)</div>
	<div id="e_lokal" style="margin-left: 121mm; margin-top: -1.7mm;">(LKL)</div>

	<div style="margin-left: 156mm; margin-top: -4mm; height: 15mm;">		
		<div id="e_supplier" style="margin-bottom: 5px;">PT. ULTIMA SOLUSI PAPERINDO</div>
		<div id="e_alamat" style="margin-bottom: 5px;">SENTRA PRIMA TEKNO PARK B-7</div>
		<div id="e_kota">TANGERANG</div>
	</div>
		...
		<table id="tbl_print" width="97%" style="font-size: 17.5px;">
			<?php for ($i = 0; $i < 20; $i++) { ?>
				<tr style="height: 4.89mm;">
					...
					<td width="48%" style="padding-left: 5mm;"></td>
	...
	<table width="100%" style="font-size: 17.5px; font-weight: bold; color: #424242;">
		<tr style="height: 10mm;">
			...
			<td width="21%" align="center" id="e_pimpinan">xxx</td>
			<td width="19%" align="center" id="e_akuntan">xxx</td>
			<td width="20%" align="center" id="e_pembelian">xxx</td>
		</tr>
	...
	function cetak(btn) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('#e_tgl').html(data[0].TGL);
				$('#e_nomor_spp').html(data[0].NOMOR_SPP + '&nbsp &nbsp (' + data[0].NOMER.substring(0, 16) + ')');
				$('#e_lokal').html('(' + lokal + ')');
				$('#e_supplier').html(data[0].SUPPLIER);
				$('#e_alamat').html(data[0].ALAMAT);
