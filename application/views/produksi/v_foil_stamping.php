...
<style> body {padding-right: 0 !important} .select2-container--open {z-index: 9999999;} .select2-selection__choice {color: #000 !important;} @media print { @page {size: landscape;} #pr_body tbody td {height: 20px; vertical-align: middle; padding-right: 5px;}}</style>
...
// Load Dokumen
	$(document).ready(function() {
		...
		setTimeout(function() {$('#btn_add').click();}, 3000);
	});
...
// Tambah Barang
	$('#btn_add').click(function() {
		...
		$('#tabel_input tbody').append(
			...
			'</select></td>' +
			'<td><input type="text" class="form-control nums" name="nmr_pp" onfocusout="isi_nomor(this)" style="text-align: center;" autocomplete="off" maxlength="3"></td>' +
			...
			'<td align="center"><input type="text" class="form-control nums" name="qty_roll" onchange="isi_total()" style="text-align: center;" autocomplete="off"></td>' +
			'<td align="center"><input type="text" class="form-control" name="total_foil" style="text-align: center;" readonly></td>' +
			'<td align="center"><input type="text" class="form-control nums" name="hasil" onchange="isi_sisa()" style="text-align: center;" autocomplete="off"></td>' +
			'<td align="center"><input type="text" class="form-control nums" name="waste" onchange="isi_sisa()" style="text-align: center;" autocomplete="off"></td>' +
