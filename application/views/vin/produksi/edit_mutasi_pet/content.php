    ...
    <section class="content">
      ...
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">
            <b><font color="White"> EDIT MUTASI PET</font></b>
          </h3>
          ...
          <div class="card card-primary" id="bodyinput">
			...
			<table width="100%">
					<tr>
						...
						<td width="40%">
						<input type="text" id="no_mutasi" name="no_mutasi" class="form-control" value="<?php echo $no_mutasi; ?>" style="width: 80%;" maxlength="50" autocomplete="off">
					...
					<tr>
						<th>Pengirim</th>
						<td>
						<select  id="cmbPengirim" name='cmbPengirim' style="width: 90%;" onchange="cari_pengirim()" class="select">
						...
						<th>Penerima</th>
						<td>
						<select  id="cmbPenerima" name='cmbPenerima' style="width: 90%;" onchange="cari_penerima()" class="select">
            ...
            <div class="card-footer">
                <table>
                    <tr>
                        <td width="150">
                            <button type="button" class="btn btn-block btn-warning" onclick="klik_roll()"><i class="fa fa-plus-square m-2"></i><b>Roll</b></button>
                        </td>
                        <td width="10"></td>
                        <td width="150">
                            <button type="button" class="btn btn-block btn-primary" onclick="simpan_edit_mutasi()"><i class="fa fa-save m-2"></i><b>Simpan</b></button>
                        </td>
                        <td width="10"></td>
                        <td width="150">
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td  width="5%">&nbsp</td>
												...
												?>
													...
													<td  width="5%"><button type="button" class="btn btn-block btn-danger" title="Hapus Roll" onclick="hapus_roll(this)" style="margin-top: 0; text-align: center;"><i class="fa ion-trash-a"></i></button></td>
