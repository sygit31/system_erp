    ...
    <section class="content">
      ...
      <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <form  role="form" method="POST" action="<?php echo site_url('sgt/qc/master_parameter/save_testcode');?>" onsubmit="return validasi()">
            ...
            <div class="card-footer">
              <table>
                <tr>
                  ...
                  <td width="10"></td>
                  <td width="150"><a href="<?php echo site_url('sgt/qc/master_parameter'); ?>" class="btn btn-block btn-danger">Batal</a></td>
                </tr>
              </table>
            </div>
          </div>
                ...
                <tbody>
                  ...
                  <?php foreach($all_data as $row){ ?>
                    <tr>
                      ...
                      <td>
                        <form method="POST" action="<?php echo site_url('sgt/qc/master_parameter/edit');?>">
